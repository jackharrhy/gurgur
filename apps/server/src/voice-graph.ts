...
export function selectVoiceGraph(peers: VoiceGraphPeer[], maximumDegree = 6): Map<string, Set<string>> {
  ...
  candidates.sort((left, right) => left.distance - right.distance
    || left.a.peerId.localeCompare(right.a.peerId) || left.b.peerId.localeCompare(right.b.peerId));
