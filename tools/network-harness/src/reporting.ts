...
export type HarnessSummarySource = Pick<HarnessReport, "clientCount" | "profiles" | "scenario" | "server">;
...
export function summarizeHarnessReport(report: HarnessSummarySource) {
  return {
    ...
    qualityProfiles: Object.fromEntries(QUALITY_PROFILE_NAMES.flatMap((name) => {
